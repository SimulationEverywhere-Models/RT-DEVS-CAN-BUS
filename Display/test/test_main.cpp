...
struct reader_defs
{
 struct out : out_port<test_input> {};
};

template<typename T>
class InputReader : public iestream_input<test_input,T,reader_defs> {
    public:
        InputReader () = default;
        InputReader (const char* file_path) : iestream_input<test_input,T,reader_defs>(file_path) {}
};
...
int main(int argc, char ** argv) {
    ...
    static std::ofstream out_data("output/lcd_out.txt");
...
AtomicModelPtr reader = cadmium::dynamic::translate::make_dynamic_atomic_model<InputReader, TIME>("reader","inputs/test.txt");
...
AtomicModelPtr can_input_1 = cadmium::dynamic::translate::make_dynamic_atomic_model<can_input,TIME>("can_input_1");
  ...
  cadmium::dynamic::modeling::Models submodels_TOP =  {reader,can_input_1,CAN_1, LCD_1};
  cadmium::dynamic::modeling::ICs ics_TOP = { 
   cadmium::dynamic::translate::make_IC<reader_defs::out, can_test_defs::DataIn>("reader","can_input_1"),
   cadmium::dynamic::translate::make_IC<can_test_defs::DataOut, canController_defs::Rx>("can_input_1","CAN_1"),
  ...
  ///****************////
    ...
    r.run_until(NDTime("00:00:20:000"));
    return 0;
}
